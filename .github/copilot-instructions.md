...
- [Functional Requirements](../docs/functional-requirements.md) - Initial draft of functional requirements
- [UI Guidelines](../docs/ui-guidelines.md) - Core UI guidelines for the TODO app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles and CI guidance
- [Coding Guidelines](../docs/coding-guidelines.md) - Narrative summary of coding style and quality principles
